...
public class VertxDaoInvocationHandler<T> implements InvocationHandler, Serializable {
    private final VertxSqlClient client;
    private final Class<T> interfaceType;
    private final Map<Method, VertxDaoMethod> methodMap;

    public VertxDaoInvocationHandler(VertxSqlClient client, Class<T> interfaceType, Map<Method, VertxDaoMethod> methodMap) {
        this.client = client;
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        return daoMethod.execute(client.getSqlClient(), args);
    }
